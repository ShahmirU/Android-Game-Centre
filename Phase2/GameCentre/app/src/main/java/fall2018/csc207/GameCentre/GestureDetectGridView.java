...
public class GestureDetectGridView extends GridView {
    ...
    private void init(final Context context) {
        ...
        gDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onSingleTapConfirmed(MotionEvent event) {
                ...
                if (context.getClass().getSimpleName().equals("SlidingTilesGameActivity")) {
                    mController.processTapMovement(context, position, true);
                } else {
                    mController.processPerfectPairsTapMovement(context, position, true);
                }
    ...
    public void setPerfectPairsGridManager(PerfectPairsGridManager manager) {
        this.perfectPairsGridManager = manager;
        mController.setPerfectPairsGridManager(manager);
    }
}
